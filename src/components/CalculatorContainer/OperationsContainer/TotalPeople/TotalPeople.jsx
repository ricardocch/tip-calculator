...
function TotalPeople({calculate,People,setPeople}) {
  ...
  return (
    <div className={style.TotalPeople}>
      ...
      <input type="text" placeholder="0" onBlur={e => blur(e)} className={ error ? style.inputError : ''} value={People} onChange={e => change(e)}/> 
    </div>
  );
}
